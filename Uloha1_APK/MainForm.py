...
class Ui_MainForm(object):
    def setupUi(self, MainForm):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("C:/Skola/AlgoritmyPK/Uloha1_APK/icons/open_file.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionOpen.setIcon(icon)
        self.actionOpen.setObjectName("actionOpen")
        self.actionExit = QtGui.QAction(parent=MainForm)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("C:/Skola/AlgoritmyPK/Uloha1_APK/icons/exit.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionExit.setIcon(icon1)
        self.actionExit.setObjectName("actionExit")
        self.actionPoint_polygon = QtGui.QAction(parent=MainForm)
        self.actionPoint_polygon.setCheckable(True)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("C:/Skola/AlgoritmyPK/Uloha1_APK/icons/pointpol.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("C:/Skola/AlgoritmyPK/Uloha1_APK/icons/clear.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionClear.setIcon(icon3)
        self.actionClear.setObjectName("actionClear")
        self.actionRay_Crossing = QtGui.QAction(parent=MainForm)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("C:/Skola/AlgoritmyPK/Uloha1_APK/icons/ray.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("C:/Skola/AlgoritmyPK/Uloha1_APK/icons/winding.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
    ...
    def analyzePointAndPositionClick(self):
            ...
            for p in polygons:
                result = a.getPointPolygonPositionRC(q, p)
                ...
                if result == 1:
                    ...
                    highlighted_pols.append(p)
                    is_boundary = True
            
            self.Canvas.setHighlightedPolygons(highlighted_pols, is_boundary)
    ...
    def analyzePointAndPositionWNClick(self):
            ...
            for p in polygons:
                result = a.getPointPolygonPositionWN(q, p) 
